        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4 contact-box">
              ...
              <p>
                <span class="contact-title">Ligue para:</span>(18)99680-9368
              </p>
            ...
            <div class="col-md-4 contact-box">
              ...
              <p>
                <span class="contact-title">Envie um e-mail:</span>
                contato@tradingzone.com
              </p>
            </div>
            <div class="col-md-4 contact-box">
              <i class="fas fa-map-marker-alt"></i>
              <p>
                <span class="contact-title">Venha nos conhecer:</span> Rua Loren
                Ipsun - 1204
              </p>
            </div>
          </div>
      ...
      <div id="copy">
        <div class="container">
          <div class="col-md-12">
            <p>
              Desenvolvido por
              <a href="https://github.com/GuilhermeBeloni" target="blank"
                >GuilhermeBeloni</a
              >
              &copy; 2022
            </p>
